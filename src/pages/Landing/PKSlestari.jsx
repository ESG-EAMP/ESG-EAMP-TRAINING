...
function PKSlestari() {
    ...
    useEffect(() => {
        const fetchPage = async () => {
            try {
                const res = await fetch(`${import.meta.env.VITE_APP_API}/static-pages/pkslestari`);
            ...
            <div className="container mt-5 mb-5">
                <article className="card shadow-sm">
                    <div className="card-body p-5">
                        <h1 className="card-title mb-4">{pageData.title || 'PKSlestari'}</h1>
                        <hr className="my-4" />
