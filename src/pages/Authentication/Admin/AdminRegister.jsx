...
function AdminRegister() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: errorMsg?.detail || 'Something went wrong',
                icon: 'error',
                confirmButtonColor: '#312259'
            });
        }
    ...
    return (
        <div className="container-fluid">
            <Title title="Admin Register" breadcrumb={[["Admin Register", "/admin-register"], "Admin Register"]} />
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-5">
                                ...
                                {currentStep === 3 ? (
                                    ...
                                    >
                                        {!isSubmitting && <><FiCheckCircle className="me-1" /> Register</>}
                                        {isSubmitting && <><i className="mdi mdi-dots-circle mdi-spin text-white me-1"></i> Registering...</>}
                                    </button>
                                ) : (
                                    <button
                                        type="button"
