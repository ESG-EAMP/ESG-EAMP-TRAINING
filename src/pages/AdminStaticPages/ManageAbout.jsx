...
function ManageAbout() {
    ...
    const fetchPage = async () => {
        try {
            setLoading(true);
            const res = await api.get('/static-pages/admin/about');
            const data = res.data;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Saved!',
                text: 'About page has been saved successfully.',
                timer: 1500,
    ...
    if (loading) {
        return (
            <div className="container-fluid">
                <Title title="Manage About Page" breadcrumb={[["Pages", "/admin/pages"], "About"]} />
                ...
                <div className="col-lg-12">
                    <div className="card">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <h5 className="">About Page Content</h5>
