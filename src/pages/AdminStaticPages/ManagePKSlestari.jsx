...
function ManagePKSlestari() {
    ...
    const fetchPage = async () => {
        try {
            setLoading(true);
            const res = await api.get('/static-pages/admin/pkslestari');
            const data = res.data;
            setTitle(data.title || 'PKSlestari');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Saved!',
                text: 'PKSlestari page has been saved successfully.',
                timer: 1500,
                showConfirmButton: false
            });
        } catch (error) {
            console.error('Error saving page:', error);
            const errorMessage = error.response?.data?.detail || error.message || 'Failed to save page.';
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: errorMessage
    ...
    if (loading) {
        return (
            <div className="container-fluid">
                <Title title="Manage PKSlestari Page" breadcrumb={[["Pages", "/admin/pages"], "PKSlestari"]} />
                ...
                <div className="col-lg-12">
                    <div className="card">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <h5 className="">PKSlestari Page Content</h5>
                            ...
                            {!isPreviewMode ? (
                                <div className="mb-3">
                                    ...
                                    <CKEditorWrapper
                                        ...
                                        config={{
                                            placeholder: 'Enter PKSlestari page content here...',
                                            simpleUpload: {
...
export default ManagePKSlestari;
