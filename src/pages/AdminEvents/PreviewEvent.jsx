...
import { FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaLink, FaEye } from 'react-icons/fa';
...
function PreviewEvent() {
  ...
  if (loading) {
    return (
      <div className="container-fluid">
        <Title
          title="Preview Event"
          breadcrumb={[["Events", "/admin/events"], "Preview"]}
        />
  ...
  return (
    <div className="container-fluid">
      ...
      <div style={{ paddingTop: '2rem', paddingBottom: '4rem', backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
              ...
              <div className="bg-white rounded-4 shadow-sm p-4 sticky-top" style={{ top: '100px' }}>
                ...
                <div className="pt-3 border-top">
                  <button
                    ...
                    onClick={() => navigate('/admin/events')}
                    style={{ backgroundColor: '#46015E', borderColor: '#46015E' }}
                  >
                    <FaArrowLeft className="me-1" />
                    Back to Events
                  </button>
